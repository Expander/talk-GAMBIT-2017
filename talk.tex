...
\begin{frame}{Add 1-loop corrections for $\lambda$}
...
\begin{frame}{Parameter scan over $X_t/\MS$}
  ...
  \end{center}
  1- and 2-loop contributions from \bigcite{1407.4081, 1703.08166}
\end{frame}
...
\begin{frame}{Summary}
  ...
  \\[0.5em]
  \emph{Speed:} multi-threading, expression templates, lazy evaluation
  \\[1em]
