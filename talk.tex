...
\begin{frame}{Example: BVP in the CMSSM}
  ...
  \begin{tikzpicture}
    ...
    \draw[thick,darkgreen] (0,4) node[left]{$M_X$} -- node[above = 0.5cm,black]{GUT} (3,4) node[right,black]{fix $m_{\tilde{f}}^2, A_f, M_i$};
...
\begin{frame}{Step 4: Define low-scale boundary condition}
  ...
  \begin{tikzpicture}
    ...
    \draw[thick,darkgreen] (0,4) node[left]{$M_S$} -- node[above = 0.5cm,black]{MSSM} (3,4) node[right,black]{fix $\lambda$ from MSSM};
    \draw[thick,dashed,darkgreen] (0,1.5) node[left]{$M_t$} -- (3,1.5) node[right,black]{fix $\mu^2$ by EWSB};
    \draw[thick,red] (0,1) node[left]{$M_Z$} -- node[above = 1.2cm,black]{SM} node[below = 0.5cm,black]{SM(5)} (3,1) node[right]{fix $g_i, y_f, v$ from obs.};
  \end{tikzpicture}
  \end{center}
\end{frame}
...
\begin{frame}{Step 5: Define EWSB-scale boundary condition}
  ...
  \begin{tikzpicture}
    \path[arrow] (0,0) -- (0,5) node[left]{$Q$};
    \draw[thick,darkgreen] (0,4) node[left]{$M_S$} -- node[above = 0.5cm,black]{MSSM} (3,4) node[right,black]{fix $\lambda$ from MSSM};
    \draw[thick,dashed,red] (0,1.5) node[left]{$M_t$} -- (3,1.5) node[right]{fix $\mu^2$ by EWSB};
    \draw[thick,darkgreen] (0,1) node[left]{$M_Z$} -- node[above = 1.2cm,black]{SM} node[below = 0.5cm,black]{SM(5)} (3,1) node[right,black]{fix $g_i, y_f, v$ from obs.};
  \end{tikzpicture}
  \end{center}
\end{frame}
...
\begin{frame}{Step 5: Define EWSB-scale boundary condition}
  Fix $\mu^2$ by EWSB condition at the scale $Q$ = \texttt{MEWSB}:\\[2em]
  \usebox{\listbox}
\end{frame}
...
\begin{frame}{Step 6: Define high-scale boundary condition}
  ...
  \begin{tikzpicture}
    \path[arrow] (0,0) -- (0,5) node[left]{$Q$};
    \draw[thick,red] (0,4) node[left]{$M_S$} -- node[above = 0.5cm,black]{MSSM} (3,4) node[right]{fix $\lambda$ from MSSM};
    \draw[thick,dashed,darkgreen] (0,1.5) node[left]{$M_t$} -- (3,1.5) node[right,black]{fix $\mu^2$ by EWSB};
    \draw[thick,darkgreen] (0,1) node[left]{$M_Z$} -- node[above = 1.2cm,black]{SM} node[below = 0.5cm,black]{SM(5)} (3,1) node[right,black]{fix $g_i, y_f, v$ from obs.};
  \end{tikzpicture}
  \end{center}
...
\begin{frame}{Step 8: Build the spectrum generator}
  ...
  \item[\texttt{2}:] searches for required libraries and creates the \lstinline{Makefile}
  \item[\texttt{3}:] calls \SARAH, generates the C++ code and compiles it
  \end{itemize}
\end{frame}
...
\begin{frame}{Parameter scan}
  ...
  Open \Mathematica\ and type:\\[1.5em]
  \usebox{\listbox}
  \\[1em]
  ...
  \item[] \texttt{FSHSSUSYCalculateObservables[<handle>]}
...
\begin{frame}{Parameter scan}
  \usebox{\listbox}
  \\[1em]
  See \bigcite{1710.03760} for detailed documentation.
\end{frame}
...
\begin{frame}{Estimate the EFT uncertainty}
  Scan over $\MS \in [100, 5000]\eh{GeV}$ with $X_t/\MS = 2$, $\tan\beta = 5$:\\[2em]
  \usebox{\listbox}
\end{frame}
...
$ cd models/MRSSM/
$ ./run_MRSSM.x --slha-input-file=LesHouches.in.MRSSM
...
Block FlexibleSUSYLowEnergy
...
\begin{frame}{NLL resummation of $M_h$ (FlexibleEFTHiggs)}
  ...
  \begin{tikzpicture}
    \path[arrow] (0,0) -- (0,5) node[left]{$Q$};
    \draw[thick,darkgreen] (0,4) node[left]{$M_S$} -- node[above = 0.5cm,black]{MRSSM} (3,4) node[right,black]{fix $\lambda$ from \textcolor{red}{$M_h^\SM = M_h^\MRSSM$} at 1L};
    \draw[thick,dashed,darkgreen] (0,1.5) node[left]{$M_t$} -- (3,1.5) node[right,black]{calculate $M_h$ at 2L};
    \draw[thick,darkgreen] (0,1) node[left]{$M_Z$} -- node[above = 1.2cm,black]{SM} node[below = 0.5cm,black]{SM(5)} (3,1) node[right,black]{fix $g_i, y_f, v$ from obs.};
  \end{tikzpicture}
  \end{center}
  See \bigcite{1609.00371} for more details.
\end{frame}
...
\begin{frame}[noframenumbering]{Example: CNMSSM}
  ...
  \begin{tikzpicture}
    \path[arrow] (0,0) -- (0,5) node[left]{$Q$};
    \draw[thick,darkgreen] (0,4) node[left]{$M_X$} -- node[above = 0.5cm,black]{GUT} (3,4) node[right,black]{fix $m_{\tilde{f}}^2, A_f, M_i, \lambda, \textcolor{red}{m_S^2}$};
